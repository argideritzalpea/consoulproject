...
def makeWebhookResult(req):
    ...
    speech = "The " str(db.codebook.distinct(characteristic)[0]["Construction"]) + "of " zone + " is " + str(db.factbook.distinct(zone)[0][characteristic]) + " " + str(db.codebook.distinct(characteristic)[0]["Units"]) 
