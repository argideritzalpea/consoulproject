...
def makeWebhookResult(req):
    ...
    if req.get("result").get("action") == "ask.question":
        ...
        speech = "The difference of " + country + "'s " + characteristic + " and that of " + country2 + " is " + str(int((db.factbook.distinct(country)[0][characteristic])) - int((db.factbook.distinct(country2)[0][characteristic]))) + " " + str(db.codebook.distinct(characteristic)[0]["Units"])
    else:
        return {}
